...
EXAMPLES = r'''
# First result
- debug: msg="{{ lookup('tedleyem.tpm.project', 'myproject') }}"
# returns : dict
- debug: msg="{{ lookup('tedleyem.tpm.project', 'myproject', field='name') }}"
# returns : str

# All matching results
- debug: msg="{{ lookup('tedleyem.tpm.project', 'myproject', all=True) }}"
# returns : [dict, ...]
- debug: msg="{{ lookup('tedleyem.tpm.project', 'myproject', all=True, field='name') }}"
# returns : [str, ...]
'''
